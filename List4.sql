...
			WHERE TABLE_SCHEMA = 'Morawiec' AND TABLE_NAME = 'FACT_SALES'))
...
VALUES ('Styczeñ'), ('Luty'), ('Marzec'), ('Kwiecieñ'), ('Maj'), ('Czerwiec'), ('Lipiec'), ('Sierpieñ'), ('Wrzesien'), ('PaŸdziernik'), ('Listopad'), ('Grudzieñ');
